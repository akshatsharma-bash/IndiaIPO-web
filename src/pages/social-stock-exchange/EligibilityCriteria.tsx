  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      <SEOHead
        ...
        description="Eligibility Criteria to qualify as Social Enterprise"
      />
      <Header />
      ...
      <main className="flex-grow pt-32 pb-20">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-10 flex-wrap font-medium">
            ...
            <Link to="/social-stock-exchange" className="hover:text-[#f59e08] transition-colors">Social Stock Exchange</Link>
            <ChevronRight className="h-4 w-4" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {eligibleActivities.map((activity, index) => (
                        <div key={index} className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100 hover:border-[#f59e08]/30 transition-colors group">
                          <div className="mt-1 bg-white p-1 rounded-md shadow-sm border border-slate-100 group-hover:bg-[#f59e08] transition-colors">
