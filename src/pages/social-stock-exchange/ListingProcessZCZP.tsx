...
const ListingProcessZCZP = () => {
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      <SEOHead
        title="Listing process of ZCZP on SSE | India IPO"
        description="Listing process of ZCZP on SSE"
      />
      <Header />
      ...
      <main className="flex-grow pt-32 pb-20">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-10 flex-wrap font-medium">
            <Link to="/" className="hover:text-[#f59e08] flex items-center gap-1 transition-colors">
              <Home className="h-4 w-4" /> Home
            </Link>
            <ChevronRight className="h-4 w-4" />
            <Link to="/social-stock-exchange/sse-introduction" className="hover:text-[#f59e08] transition-colors">Social Stock Exchange</Link>
            <ChevronRight className="h-4 w-4" />
              ...
              <div className="service-content-box bg-white">
                ...
                <div className="service-content">
                  ...
                  <div id="key-steps">
                    ...
                    <p>The process that all Not-for-profit organizations (NPOs) intending to list their Zero Coupon Zero Principal (ZCZPs) on the SSE segment must follow is as given below:</p>

                    <div className="space-y-6 mt-8">
                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>1. Execution of Listing Agreement:</h3>
                        <p>The NPO should provide a duly signed listing agreement together with its listing application for the ZCZPs on the recognized exchange (NSE or BSE).</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>2. Dematerialization of ZCZPs:</h3>
                        <p>The ZCZPs should be dematerialized as per the Depositories Act, 1996 and should be admitted to at least one of the depositories (NSDL or CDSL).</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>3. Appointment of Registrar to the Issue:</h3>
                        <p>The NPO must appoint a SEBI-registered Registrar to the Issue to manage allotment and investor servicing.</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>4. Appointment of Advisors/Consultants (Optional):</h3>
                        <p>Although the appointment of advisors or consultants is not compulsory, in case they are hired, their information should be provided in the fundraising document.</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>5. Draft Fundraising Document Filing:</h3>
                        <p>The NPO must submit a draft fundraising document to the SSE in which it is registered, together with the relevant fees. This draft is valid within six months of filing.</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>6. Public Comment Period:</h3>
                        <p>The SSE will post the draft fundraising document on its site at least 21 days to allow comments by the public.</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>7. Clarifications from NPO (If Required):</h3>
                        <p>The SSE can request further information or clarification of the NPO at this time.</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>8. Review and Observations by SSE:</h3>
                        <p>The SSE will give its official comments on the draft document within 30 days from the date of filing the draft or receipt of clarifications, whichever is earlier.</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>9. Final Fundraising Document and Offer Period:</h3>
                        <p>The NPO should include the observations of SSE and submit the final fundraising document. The public issue of ZCZPs should be open for at least 3 working days and not exceed 10 working days.</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>10. Issue Pricing:</h3>
                        <p>ZCZPs will be issued at face value as indicated in the fundraising document.</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>11. Private Placement (if applicable):</h3>
                        <p>The same procedural framework shall be followed, to the extent applicable, for private placement of ZCZPs.</p>
                      </div>

                      <div className="p-6 bg-white rounded-2xl border-2 border-dashed border-slate-200">
                        <h3>12. Minimum Issue and Application Size:</h3>
                      ...
                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>13. Minimum Subscription Requirement:</h3>
                        <p>The issue should be subscribed to by at least 75% of the total issue size to be successful.</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>14. Listing Timeline:</h3>
                        <p>The ZCZPs should be listed on the SSE segment of the exchange within T+10 trading days, where T is the date of closure of the issue.</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>15. Non-Tradability on Secondary Market:</h3>
                        <p>NPOs do not offer ZCZPs that can be traded in the secondary market. However, they can be transferred to legal heirs in exceptional cases.</p>
                      </div>
                    </div>
                  </div>

                  <div className="mt-12" id="obj-sse">
                    <h2>NSE SSE Listing Checklist for Instruments</h2>
                    <p>To list ZCZPIs on the NSE Social Stock Exchange segment, the issuer must ensure compliance with the following:</p>
                    <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 mt-6">
                      ...
                      <div className="orhp m-0 p-0 border-none bg-transparent">
                        <ul>
                  ...
                  <div className="mt-12" id="post-issue">
                    <h3>Post-Issue Listing Compliance</h3>
                    <div className="orhp">
                      <ul>
                  ...
                  <div className="mt-12" id="bse-listing">
                    <h2>BSE SSE Listing Checklist for Instruments</h2>
                    <p>The BSE Social Stock Exchange (BSE-SSE) requires similar but specifically tailored documentation and procedures.</p>
                    <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 mt-6">
                      <h4 className="mb-4">BSE SSE Listing Pre-requisites</h4>
                      <div className="orhp m-0 p-0 border-none bg-transparent">
                        <ul>
                  ...
                  <div className="mt-12" id="required-listing-zczpi">
                    <h3>Required Documents for Listing of ZCZPIs</h3>
                    <div className="orhp">
                      <ul>
                  ...
                  <div className="mt-12" id="additional-bse">
                    <h3>Additional BSE Requirements</h3>
                    <div className="orhp">
                      <ul>
                  ...
                  <div className="mt-12" id="issuer-allot">
                    <h2>Documents to Be Provided by Issuer for Basis of Allotment of ZCZP</h2>
                    <p>The ZCZPIs shall be allotted in a fair, transparent and SEBI-compliant manner. The NPO shall submit the following documents to determine the basis of allotment:</p>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>1. Final Fundraising Document</h3>
                        <div className="orhp m-0 p-0 border-none bg-transparent">
                          <ul>
                      ...
                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>2. Board/Governing Body Resolution</h3>
                        <div className="orhp m-0 p-0 border-none bg-transparent">
                          <ul>
                      ...
                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>3. Application Forms and Bids</h3>
                        <div className="orhp m-0 p-0 border-none bg-transparent">
                          <ul>
                      ...
                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>5. Allotment Finalization Certificate</h3>
                        <div className="orhp m-0 p-0 border-none bg-transparent">
                          <ul>
                      ...
                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>6. Escrow Account Details</h3>
                        <div className="orhp m-0 p-0 border-none bg-transparent">
                          <ul>
                  ...
                  <div className="mt-12" id="provid-zcpis">
                    <h2>Documents to Be Provided for Listing of ZCZPIs</h2>
                    <p>After the successful allocation of the issue, the listing of ZCZPIs entails the submission of a final package of documents to the SSE.</p>

                    <div className="space-y-6 mt-8">
                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>1. Final Allotment Document</h3>
                        <div className="orhp m-0 p-0 border-none bg-transparent">
                          <ul>
                      ...
                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>2. ISIN Activation Confirmation</h3>
                        <div className="orhp m-0 p-0 border-none bg-transparent">
                          <ul>
                      ...
                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>3. Listing Application Form</h3>
                        <p>Standard format as prescribed by NSE/BSE.</p>
                      </div>

                      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        <h3>4. Trustee/Director Declaration</h3>
                        <div className="orhp m-0 p-0 border-none bg-transparent">
                          <ul>
...
export default ListingProcessZCZP;