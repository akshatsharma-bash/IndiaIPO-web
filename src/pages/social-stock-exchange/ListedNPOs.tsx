  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      <SEOHead
        ...
        description="List of Registered and Listed NPOs on BSE SSE and NSE SSE"
      />
      <Header />
                        ...
                        <tbody className="bg-white divide-y divide-slate-100">
                          <tr className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-sm text-slate-600 border-r border-slate-100">
                              <span className="block font-bold">UNNATI-SE</span>
                              <span className="text-xs">INE0O4Y01018</span>
                            </td>
                          ...
                          <tr className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-sm text-slate-600 border-r border-slate-100">
                              <span className="block font-bold">MUKTI-SE</span>
                              <span className="text-xs">INE0TMY01010</span>
                            </td>
                          ...
                          <tr className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-sm text-slate-600 border-r border-slate-100">Kolkata</td>
                            <td className="px-6 py-4 text-sm text-slate-600 border-r border-slate-100">
                              <span className="block font-bold">MISSING-SE</span>
                              <span className="text-xs">INE0GU4I01014</span>
                            </td>
                          ...
                          <tr className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-sm text-slate-600 border-r border-slate-100">
                              <span className="block font-bold">EF-SE</span>
                              <span className="text-xs">INE0OR5I01013</span>
                            </td>
                          ...
                          <tr className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-sm text-slate-600 border-r border-slate-100">
                              <span className="block font-bold">SARTHAK-SE</span>
                              <span className="text-xs">INE0O4Y01026</span>
                            </td>
                          ...
                          <tr className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-sm text-slate-600 border-r border-slate-100">New Delhi</td>
                            <td className="px-6 py-4 text-sm text-slate-600 border-r border-slate-100">
                              <span className="block font-bold">TRIF-SE</span>
                              <span className="text-xs">INE0OR5U01015</span>
                            </td>
                          ...
                          <tr className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-sm text-slate-600 border-r border-slate-100">
                              <span className="block font-bold">SVYM-SE</span>
                              <span className="text-xs">INE0TYRI01015</span>
                            </td>
                          ...
                          <tr className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-sm text-slate-600 border-r border-slate-100">
                              <span className="block font-bold">SWADES-SE</span>
                              <span className="text-xs">INE0O4Y01034</span>
                            </td>
                          ...
                          <tr className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-sm text-slate-600 border-r border-slate-100">
                              <span className="block font-bold">PBT-SE</span>
                              <span className="text-xs">INE0O4Y01042</span>
                            </td>
