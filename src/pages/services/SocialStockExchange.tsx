          ...
          <div className="space-y-6">
            {[
              ...
              <Link
                to={item.link}
                key={idx}
                className={`block ${item.c} border p-8 rounded-3xl space-y-3  relative overflow-hidden group  transition-all`}
              >
          ...
          <div className="bg-[#001529] p-10 md:p-14 rounded-[3rem] text-white space-y-6 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-white/60 text-xs font-semibold leading-relaxed max-w-xl">
                We guide NGOs, Societies, and Trusts through the complexities of
                registration and ZCZP issuance. Access capital that matches your
                impact goals.
              </p>
              <div className="pt-4 flex flex-col sm:flex-row gap-4">
                ...
                >
                  <Link to="/contact">Schedule Eligibility Sync</Link>
                </Button>
                <div className="flex items-center gap-3 px-6 py-2 bg-white/5 rounded-xl border border-white/10">
                  ...
                  <span className="text-xs font-black">+91-74283-37280</span>
                </div>
              </div>
            </div>
          </div>
...
export default SocialStockExchange;
