...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead title="Blog" description="IPO insights, market analysis, GMP updates, and investment guides from India IPO experts." keywords="IPO blog, IPO news, GMP updates, market analysis" />
      <Header />
      <main>
        <section
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {blogs.map((post, idx) => (
                  ...
                  >
                    <div className="relative aspect-video overflow-hidden shrink-0 bg-white">
                      <img
                        src={getImgSrc(post.image_url) || fallbackImage}
                        alt={post.title}
