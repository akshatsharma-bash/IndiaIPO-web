    ...
    <div className="min-h-screen bg-slate-950 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-10">
          ...
          >
            <img onClick={() => navigate("/")} src={logoImg} alt="IndiaIPO Logo" className="h-9 w-auto" />
          ...
          <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.button
                ...
                className="w-full py-3.5 bg-amber-700 hover:bg-amber-600 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-amber-900/30 transition-all text-sm"
              >
                {loading ? (
                  <>
