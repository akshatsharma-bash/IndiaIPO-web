            ...
            <Tabs defaultValue="general" className="w-full">
              ...
              <TabsContent value="general" className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input placeholder="ipo-advisory-in-kolkata" value={newData.slug} onChange={(e) => setNewData({ ...newData, slug: e.target.value })} />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2 md:col-span-3">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <label className="flex-1 flex flex-col items-center justify-center border-2 border-dashed border-border rounded-xl p-4 hover:bg-muted/50 cursor-pointer transition-colors">
              ...
              <TabsContent value="content" className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea placeholder="List some major IPOs handled or successes..." value={newData.success_stories} onChange={(e) => setNewData({ ...newData, success_stories: e.target.value })} />
                </div>
              ...
              <TabsContent value="contact" className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input type="email" placeholder="contact@advisor.com" value={newData.cemail} onChange={(e) => setNewData({ ...newData, cemail: e.target.value })} />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input placeholder="https://..." value={newData.cweblink} onChange={(e) => setNewData({ ...newData, cweblink: e.target.value })} />
                  </div>
                  <div className="space-y-2 md:col-span-2">
                    <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Full Office Address</label>
                    <Textarea placeholder="123, Financial Building..." value={newData.caddress} onChange={(e) => setNewData({ ...newData, caddress: e.target.value })} />
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="seo" className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input placeholder="SEO Title" value={newData.meta_title} onChange={(e) => setNewData({ ...newData, meta_title: e.target.value })} />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Meta Keywords</label>
                  <Input placeholder="key, words, separated" value={newData.meta_keywords} onChange={(e) => setNewData({ ...newData, meta_keywords: e.target.value })} />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Meta Description</label>
                  <Textarea placeholder="Meta description for search engines" value={newData.meta_desc} onChange={(e) => setNewData({ ...newData, meta_desc: e.target.value })} />
                </div>
              </TabsContent>
            </Tabs>
                  ...
                  <Tabs defaultValue="general" className="w-full">
                    ...
                    <TabsContent value="content" className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea value={editData.success_stories || ""} onChange={(e) => setEditData({ ...editData, success_stories: e.target.value })} />
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <TabsContent value="contact" className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input value={editData.cemail || ""} onChange={(e) => setEditData({ ...editData, cemail: e.target.value })} />
                        </div>
                        <div className="space-y-2">
                          <label className="text-[10px] font-bold uppercase text-muted-foreground">Contact Mobile</label>
                          <Input value={editData.cmobile || ""} onChange={(e) => setEditData({ ...editData, cmobile: e.target.value })} />
                        </div>
                        <div className="space-y-2">
                          <label className="text-[10px] font-bold uppercase text-muted-foreground">Website Link</label>
                          <Input value={editData.cweblink || ""} onChange={(e) => setEditData({ ...editData, cweblink: e.target.value })} />
                        </div>
                        <div className="space-y-2 md:col-span-2">
                          <label className="text-[10px] font-bold uppercase text-muted-foreground">Full Address</label>
                          <Textarea value={editData.caddress || ""} onChange={(e) => setEditData({ ...editData, caddress: e.target.value })} />
                        </div>
                      </div>
                    </TabsContent>
                    ...
                    <TabsContent value="seo" className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea value={editData.meta_desc || ""} onChange={(e) => setEditData({ ...editData, meta_desc: e.target.value })} />
                      </div>
                    </TabsContent>
                  </Tabs>
