...
const ManageWeeklyDigests = () => {
  ...
  const del = async (id: number) => {
    ...
    try {
      const res = await fetch(`/api/weekly-digests/${id}`, { method: "DELETE" });
      ...
      <div className="space-y-6">
        ...
        {showNew && (
          <div className="bg-card border border-border rounded-xl p-5 space-y-3 shadow-sm animate-in fade-in slide-in-from-top-2">
            <h3 className="font-semibold">New Weekly Digest</h3>
...
export default ManageWeeklyDigests;
