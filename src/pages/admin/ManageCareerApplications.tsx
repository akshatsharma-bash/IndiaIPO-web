...
const ManageCareerApplications = () => {
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      const res = await fetch(`/api/career/admin/enquiries/${id}`, { method: "DELETE" });
      if (res.ok) {
          ...
          {selectedApp && (
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-2">
                ...
                <div className="p-5 rounded-2xl bg-secondary/10 border border-border text-sm leading-relaxed whitespace-pre-wrap max-h-[250px] overflow-y-auto break-words shadow-inner">
