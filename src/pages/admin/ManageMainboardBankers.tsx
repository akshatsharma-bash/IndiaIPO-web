              ...
              >
                ...
                <Tabs defaultValue="general" className="mt-4">
                  <TabsList className="grid w-full grid-cols-5">
                    ...
                    <TabsTrigger value="contact">Contact & Head Office</TabsTrigger>
                  ...
                  <TabsContent value="general" className="space-y-4 py-4 pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input value={form.title} onChange={(e) => handleTitleChange(e.target.value)} placeholder="e.g. ICICI Securities" />
                      </div>
                      ...
                      <div className="space-y-2 md:col-span-2">
                        ...
                        <div className="flex gap-2">
                          <Input value={form.image} onChange={(e) => setForm({ ...form, image: e.target.value })} placeholder="URL..." className="flex-1" />
                  ...
                  <TabsContent value="analytics" className="space-y-6 pt-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      <div className="space-y-3">
                        <label className="text-sm font-semibold">Year-wise IPO Listing</label>
                        <JsonArrayEditor
                      ...
                      <div className="space-y-3">
                        <label className="text-sm font-semibold">IPOs by Size (Stats)</label>
                        <JsonArrayEditor
                      ...
                      <div className="space-y-3">
                        <label className="text-sm font-semibold">IPOs by Subscription (Group)</label>
                        <JsonArrayEditor
                      ...
                      <div className="space-y-3">
                        <label className="text-sm font-semibold">Merchant Banker FAQ</label>
                        <JsonArrayEditor
                          value={form.faqs}
                  ...
                  <TabsContent value="contact" className="space-y-4 pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input value={form.cemail} onChange={(e) => setForm({ ...form, cemail: e.target.value })} placeholder="contact@..." />
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input value={form.cweblink} onChange={(e) => setForm({ ...form, cweblink: e.target.value })} placeholder="https://..." />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-semibold">Head Office / Address</label>
                        <Textarea value={form.caddress} onChange={(e) => setForm({ ...form, caddress: e.target.value })} rows={2} placeholder="Full address..." />
                      </div>
                    </div>
                  ...
                  <TabsContent value="seo" className="space-y-4 pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-semibold">Related Merchant Bankers (Top Selection)</label>
                        <MultiSelect
                      ...
                      <div className="md:col-span-2 space-y-2">
                        ...
                        <Textarea value={form.meta_desc} onChange={(e) => setForm({ ...form, meta_desc: e.target.value })} rows={3} placeholder="SEO Description..." />
                      </div>
                      <div className="md:col-span-2 space-y-2">
                        <label className="text-sm font-semibold">Meta Keywords</label>
                        <Input value={form.meta_keywords} onChange={(e) => setForm({ ...form, meta_keywords: e.target.value })} placeholder="keyword1, keyword2..." />
                      </div>
                    </div>
                  </TabsContent>
                </Tabs>
