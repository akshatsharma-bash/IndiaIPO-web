...
const activityIcon: Record<string, { icon: React.ElementType; color: string; label: string }> = {
  ...
  investor: { icon: Star, color: "text-yellow-400", label: "Investor Interest" },
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-sm overflow-hidden animate-in fade-in slide-in-from-top-4 duration-700">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">Review the most recent incoming enquiries from your website</p>
              </div>
              <Link to="/admin/leads" className="text-xs font-bold text-primary hover:underline flex items-center gap-1 group">
                View All Enquiries
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {stats.recentActivity.slice(0, 6).map((item, i) => {
                ...
                const bgColors: Record<string, string> = {
                  ...
                  "text-yellow-400": "bg-yellow-50 border-yellow-100 text-yellow-600",
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] font-bold text-muted-foreground uppercase opacity-70 group-hover:opacity-100">
                    ...
                    <div className="mt-auto pt-2 flex items-center justify-between border-t border-border/40">
                      ...
                      <ArrowUp className="h-3 w-3 text-primary opacity-0 group-hover:opacity-100 group-hover:-translate-y-0.5 transition-all" />
                    </div>
                  </Link>
                );
              })}
