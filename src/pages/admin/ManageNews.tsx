...
const ManageNews = () => {
  ...
  const handleEdit = (n: NewsItem) => {
    setForm({
      ...
      content: n.content || "",
      published_at:
        (n.published_at || "").split("T")[0] || emptyForm.published_at,
      image: n.image || "",
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <div className="relative">
                        ...
                        <Button
                          type="button"
                          variant="outline"
                          className="shrink-0 flex items-center gap-2 pointer-events-none"
                        >
                    ...
                    <p className="text-[10px] text-muted-foreground mt-1">
                      Direct URL or upload JPG/PNG (Max 2MB)
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <RichEditor
                      ...
                      placeholder="Full HTML or text content here..."
                    />
                  </div>
                  <Button
                    onClick={handleSave}
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border bg-muted/50">
                    <th className="text-left font-semibold py-3 px-4 w-12">
                      Image
                    </th>
                    <th className="text-left py-3 px-4 font-semibold max-w-[300px]">
                      Headline
                    </th>
