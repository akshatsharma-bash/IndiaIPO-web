...
const emptyForm = { title: "", description: "", content: "", published_at: new Date().toISOString().split('T')[0], image: "", category: "IPO", status: "published" };
...
const ManageNews = () => {
  ...
  useEffect(() => { fetchNews(1); }, [filterCategory]);
