...
import { Trash2, CheckCircle, Mail, Phone, Building2, User, Clock, MessageSquareText, Copy, EyeOff, Eye, Download } from "lucide-react";
                ...
                <TableRow key={e.id} className={`${!e.is_read ? "bg-primary/5 font-medium" : "text-muted-foreground"}`}>
                  ...
                  <TableCell>
                    <div className="flex flex-col gap-1">
                      ...
                      {e.mobile && (
                        <a href={`tel:${e.mobile}`} className="text-xs text-primary hover:underline flex items-center gap-1">
