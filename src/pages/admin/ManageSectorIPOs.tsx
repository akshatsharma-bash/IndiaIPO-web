...
const ManageSectorIPOs = () => {
  ...
  const handleOpenIpoModal = (ipo?: any) => {
    if (ipo) {
      setEditingIpo(ipo);
      let formattedDate = "";
  ...
  const handleIpoDelete = async (id: any) => {
  ...
  const handleIpoToggleStatus = async (ipo: any) => {
    try {
  ...
  return (
    <AdminLayout>
      ...
      {/* Modal for Sector IPO Create & Edit */}
        ...
        >
          <DialogHeader>
            <DialogTitle className="text-xl font-bold text-primary border-b pb-2">
              {editingIpo ? "Edit IPO By Sector" : "Add IPO By Sector"}
            </DialogTitle>
          ...
          <form onSubmit={handleIpoSubmit} className="space-y-6 py-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    required
                    className="h-10 border-muted focus:ring-primary"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    onChange={(e) => setIpoFormData({...ipoFormData, type: e.target.value})}
                    required
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    onChange={(e) => setIpoFormData({...ipoFormData, status: e.target.value})}
                    required
                  >
            ...
            <DialogFooter className="border-t pt-4">
              <Button type="button" variant="ghost" onClick={() => setIsIpoModalOpen(false)}>Cancel</Button>
              <Button type="submit" disabled={ipoSubmitting} className="min-w-[120px] bg-primary">
...
export default ManageSectorIPOs;
