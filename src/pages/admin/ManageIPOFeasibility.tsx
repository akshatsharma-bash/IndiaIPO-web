                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border bg-muted/50">
                      ...
                      <th className="text-left py-4 px-6 font-bold text-muted-foreground uppercase tracking-widest text-[9px]">Business Details</th>
                      <th className="text-left py-4 px-6 font-bold text-muted-foreground uppercase tracking-widest text-[9px]">Eligibility Stats</th>
                      <th className="text-left py-4 px-6 font-bold text-muted-foreground uppercase tracking-widest text-[9px]">Status</th>
              ...
              {entries.map((entry) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <Badge className="bg-emerald-50 text-emerald-700 border-none rounded-lg text-[9px] font-bold">Eligibility</Badge>
                  </div>
              ...
              <div className="flex flex-col">
                <div className="bg-accent p-8 text-accent-foreground relative">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-accent-foreground/80 font-medium">IPO Eligibility Assessment Details</p>
                  </div>
                </div>
