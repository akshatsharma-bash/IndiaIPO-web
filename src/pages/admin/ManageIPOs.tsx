...
import { Plus, Pencil, Trash2, Search, Loader2, ChevronLeft, ChevronRight, Upload, Image as ImageIcon, Check, History, Clock, Activity, Calendar as CalendarIcon, Info } from "lucide-react";
...
const statusColor: Record<string, string> = {
  active: "bg-success/20 text-success-dark border-success/40",
  upcoming: "bg-info/20 text-info-dark border-info/40",
  closed: "bg-destructive/20 text-destructive-dark border-destructive/40",
  listed: "bg-accent/20 text-accent-dark border-accent/40",
  Active: "bg-success/20 text-success-dark border-success/40",
  Inactive: "bg-destructive/20 text-destructive-dark border-destructive/40",
};

const rowBgColor: Record<string, string> = {
  Active: "bg-success/20 hover:bg-success/30",
  active: "bg-success/20 hover:bg-success/30",
  Upcoming: "bg-info/20 hover:bg-info/30",
  upcoming: "bg-info/20 hover:bg-info/30",
  Closed: "bg-destructive/20 hover:bg-destructive/30",
  closed: "bg-destructive/20 hover:bg-destructive/30",
  Listed: "bg-accent/20 hover:bg-accent/30",
  listed: "bg-accent/20 hover:bg-accent/30",
};
...
const ManageIPOs = () => {
  ...
  const openGmpModal = async (ipo: IPO) => {
    ...
    try {
      // Try to fetch blog data if admin_blog_id exists
      if (ipo.admin_blog_id) {
        ...
        if (res.ok) {
          ...
          // Sort by date DESC so latest is at the top
  ...
  const saveGmpHistory = async () => {
    ...
    try {
      ...
      const cleanDateOnly = (v: any) => {
        ...
        // Regex for Date | Time or just Date
