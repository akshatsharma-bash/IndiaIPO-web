...
const initialNavItems: NavMenuItem[] = [
  { id: 1, label: "Home", href: "/", visible: true, type: "link" },
  {
    id: 2, label: "About", href: "/about", visible: true, type: "dropdown", children: [
      { label: "About India IPO", href: "/about" },
  ...
  },
  {
    id: 3, label: "Services", href: "/services", visible: true, type: "mega-menu", children: [
      ...
      { label: "SME IPO Consultation", href: "/services#sme-ipo-consultant" },
      { label: "Mainline IPO Consultation", href: "/services#mainline-ipo-consultant" },
      { label: "Follow-On Public Offer (FPO)", href: "/services#ipo-advisory-services" },
      { label: "Pre-IPO Funding", href: "/services#pre-ipo-consultant" },
    ]
  },
  { id: 4, label: "Investors", href: "/investors", visible: true, type: "link" },
  {
    id: 5, label: "Merchant Bankers", href: "#", visible: true, type: "mega-menu", children: [
      { label: "SME Merchant Bankers", href: "/merchant-bankers/list-of-sme-merchant-bankers" },
      { label: "Mainboard Merchant Bankers", href: "/merchant-bankers/list-of-mainboard-merchant-bankers" },
    ]
  },
  {
  ...
  {
    id: 7, label: "News/Updates", href: "/news", visible: true, type: "dropdown", children: [
      { label: "Markets & Money Update", href: "/news#markets" },
      { label: "IPO & Market Snaps", href: "/news#snaps" },
    ]
  },
