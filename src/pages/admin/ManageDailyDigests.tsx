              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <SelectContent className="max-h-64">
                    <SelectItem value="none">-- No Blog Linked --</SelectItem>
                    {blogs.filter(b => b.category === 'daily_reporter' || b.category === 'Daily Reporter').map((blog) => (
                      <SelectItem key={blog.id} value={String(blog.id)}>{blog.title}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </div>
                  ...
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4 flex-1 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1 flex-wrap">
                          ...
                          {d.reporter_blog && (
                            <Badge variant="outline" className="text-[10px] bg-blue-50 text-blue-600 border-blue-200 flex items-center gap-1">
                    ...
                    <div className="flex items-center gap-2 flex-wrap md:flex-nowrap justify-end w-full md:w-auto mt-4 md:mt-0 pt-4 md:pt-0 border-t md:border-t-0 border-border/50">
                      ...
                      <Button
                        ...
                        onClick={() => navigate(`/admin/daily-digest-campaign?id=${d.id}`)}
                      >
                        Send Mail
                      </Button>
