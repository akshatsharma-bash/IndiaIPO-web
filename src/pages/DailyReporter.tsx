...
import {
  Home, ChevronRight, ChevronLeft, Calendar, Download, Eye,
...
const DailyReporter = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
            ...
            <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center flex flex-col items-center">
              ...
              >
                <Button
                  ...
                  className="bg-[#f59e08] hover:bg-[#ffb732] text-[#001529] font-black px-10 py-7 rounded-2xl text-lg shadow-2xl shadow-[#f59e08]/20 uppercase transition-all hover:scale-105 active:scale-95"
                >
                        ...
                        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                          {digest.pdf || digest.reporter_blog ? (
                            digest.reporter_blog && digest.linked_blog_slug ? (
                              <Link
                                to={`/daily-reporter/${digest.linked_blog_slug}`}
                              ...
                              <Link
                                to={`/daily-ipo-digest/view/${digest.id}`}
                                className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white text-[#001529] text-xs font-black hover:bg-white/90 transition-all">
      ...
      rounded-2xl border border-[#f59e08]/60 
      shadow-2xl shadow-[#f59e08]/10
      animate-in fade-in zoom-in-95 duration-300">
            ...
            <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-[#f59e08]/10 rounded-full blur-3xl" />

            <div className="relative z-10">
              <div className="w-20 h-20 bg-gradient-to-br from-[#f59e08]/20 to-[#f59e08]/5 text-[#f59e08] rounded-3xl flex items-center justify-center mx-auto mb-8 border border-[#f59e08]/20 shadow-lg">
                <MailIcon className="h-10 w-10" />
              </div>

              <h2 className="text-3xl md:text-4xl font-black mb-4 text-white tracking-tight">
                Stay ahead of <br />
                <span className="text-[#f59e08]">the curve</span>
              </h2>
              ...
              <form onSubmit={handleSubscribe} className="space-y-5">
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 focus:border-[#f59e08]/50 focus:ring-4 focus:ring-[#f59e08]/10 rounded-2xl px-6 py-5 text-white placeholder:text-white/30 outline-none transition-all shadow-inner"
                    required
                  />
                </div>
                ...
                <Button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-[#f59e08] hover:bg-[#ffb732] text-[#001529] font-black py-8 rounded-2xl text-lg shadow-xl shadow-[#f59e08]/20 transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:hover:scale-100"
                >
      ...
      <div className="fixed right-0 top-1/2 -translate-y-1/2 z-50 hidden md:block">
        <button
          onClick={() => setShowSubscribeModal(true)}
          className="bg-[#f59e08] text-[#001529] font-black py-4 px-2 rounded-l-2xl shadow-2xl vertical-text flex items-center gap-2 hover:bg-[#ffb732] transition-all hover:pl-4 group"
