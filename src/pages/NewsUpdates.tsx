                    ...
                    {paginatedNews.map((item, idx) => {
                      ...
                      return (
                        <motion.div key={item.id} custom={idx} initial="hidden" whileInView="visible"
                          ...
                          <Link to={`/news/detail/${item.slug || item.id}`}
                            ...
                            <div className="flex flex-col justify-between p-5 flex-1 relative">
                              ...
                              <div className="flex items-center justify-between mt-4 pt-3 border-t border-slate-100">
                                ...
                                <div className="flex items-center gap-2">
                                  <button
                                    onClick={(e) => { e.preventDefault(); navigator.share?.({ title: item.title, url: `/news/detail/${item.slug || item.id}` }); }}
                    ...
                    <div className="mt-14 flex flex-col items-center gap-6">
                      <div className="flex items-center justify-center gap-1.5 sm:gap-2">
                        <button
                          ...
                          className="w-9 h-9 sm:w-auto sm:px-5 sm:h-11 rounded-xl flex items-center justify-center gap-1.5 bg-white border border-slate-200 text-[#001529] hover:bg-slate-50 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-sm font-black text-[10px] sm:text-xs"
                        >
                          ...
                          {range.map((p, i) =>
                            p === "…" ? (
                              ...
                              <button key={p} onClick={() => goToPage(p as number)}
                                className={`w-9 h-9 sm:w-11 sm:h-11 rounded-xl text-xs sm:text-sm font-black transition-all ${p === currentPage
                        ...
                        <button
                          ...
                          className="w-9 h-9 sm:w-auto sm:px-5 sm:h-11 rounded-xl flex items-center justify-center gap-1.5 bg-[#001529] text-white hover:bg-[#002147] transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-md font-black text-[10px] sm:text-xs"
                        >
