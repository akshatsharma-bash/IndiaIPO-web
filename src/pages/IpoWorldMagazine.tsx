...
const IpoWorldMagazine = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEOHead
        title="IPO World Magazine | India IPO"
        description="India's only magazine dedicated 100% to IPOs. Stay updated with the latest IPO news, analysis, and insights."
      />
      <Header />
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <div className="flex items-center justify-center gap-4">
              <button
                ...
                className={`px-8 py-3 rounded-full font-bold transition-all duration-300 ${language === "english"
              ...
              <button
                ...
                className={`px-8 py-3 rounded-full font-bold transition-all duration-300 ${language === "hindi"
            ...
            >
              {/* <Button
                ...
                className="bg-[#e6b800] hover:bg-[#ffcc00] text-[#001529] font-black px-10 py-7 rounded-2xl text-lg shadow-2xl shadow-[#e6b800]/20 uppercase transition-all hover:scale-105 active:scale-95"
              >
                    ...
                    <div className="bg-white rounded-2xl overflow-hidden border border-border shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 flex flex-col h-full">
                      ...
                      <div className="p-6 flex flex-col flex-grow">
                        <div className="flex items-center gap-2 text-[11px] font-bold text-muted-foreground uppercase tracking-widest mb-2">
                          ...
                          {mag.created_at ? new Date(mag.created_at).toLocaleDateString(language === 'hindi' ? 'hi-IN' : 'en-IN', { month: 'long', year: 'numeric' }) : 'N/A'}
                        </div>
                        <h3 className="text-lg font-bold mb-6 line-clamp-2 leading-tight group-hover:text-primary transition-colors">
                          {mag.title}
                        </h3>
                        ...
                        <div className="mt-auto space-y-3">
                          {Number(mag.pdf_lock) === 1 ? (
                            <Button
                              ...
                              className="w-full rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-bold py-6 border-none shadow-lg transition-all"
                            >
                              {t.subscribeToRead}
                            </Button>
                          ) : (
                            <Button
                              asChild
                              className="w-full rounded-xl bg-[#001529] text-white hover:bg-[#003366] font-bold py-6 shadow-lg transition-all"
                            >
                              <Link to={`/ipo-world-magazine/view/${mag.id}`}>
                                {t.readNow}
                              </Link>
                            </Button>
                          )}
                          ...
                          <div className="pt-2">
                            {Number(mag.pdf_lock) === 1 ? (
                              <Button
                                onClick={() => setShowLockModal(true)}
                                variant="ghost"
                                className="w-full justify-between text-amber-600 hover:text-amber-700 hover:bg-amber-50 group/btn font-bold rounded-xl"
                              >
                              ...
                              <Button
                                asChild
                                variant="ghost"
                                className="w-full justify-between text-primary hover:text-primary hover:bg-primary/5 group/btn font-bold rounded-xl"
                              >
                                <Link to={`/ipo-world-magazine/view/${mag.id}`}>
                  ...
                  <div className="flex items-center gap-2">
                    {Array.from({ length: pagination.totalPages }, (_, i) => i + 1).map((p) => (
                      <Button
                        ...
                        className={`w-11 h-11 rounded-xl font-bold ${page === p
        ...
        <section className="bg-muted/30 py-20 border-y border-border/50">
          <div className="container mx-auto px-4">
            <div className="bg-[#001529] rounded-[2rem] p-8 md:p-16 relative overflow-hidden text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button
                  size="lg"
                  className="bg-[#e6b800] text-[#001529] font-black px-10 py-7 rounded-2xl text-lg shadow-2xl shadow-[#e6b800]/40 uppercase hover:bg-amber-400 transition-all"
                ...
                {/* <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-white bg-white text-black  font-bold px-10 py-7 rounded-2xl text-lg  hover:text-[#001529] transition-all"
                  onClick={() => {
      ...
      <Dialog open={showLockModal} onOpenChange={setShowLockModal}>
        <DialogContent className="sm:max-w-[480px] p-0 overflow-hidden border-none rounded-3xl">
          <div className="bg-gradient-to-br from-[#001529] to-[#003366] p-10 text-center text-white relative">
            ...
            <div className="space-y-4">
              <Button
                className="w-full bg-[#e6b800] hover:bg-[#ffcc00] text-[#001529] font-black py-7 rounded-2xl text-lg shadow-xl shadow-[#e6b800]/20"
              ...
              <Button
                variant="ghost"
                className="w-full text-white/50 hover:text-white hover:bg-white/5 font-bold py-6 rounded-2xl"
      ...
      <Dialog open={showSubscribeModal} onOpenChange={setShowSubscribeModal}>
        <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden border border-[#e6b800]/30 rounded-[2.5rem] bg-transparent shadow-2xl">
          <div className="bg-[#001529] p-1">
            <div className="bg-gradient-to-br from-[#001c38] to-[#001529] p-8 md:p-12 text-center rounded-[2.3rem] relative overflow-hidden border border-white/10">
              ...
              <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-[#e6b800]/10 rounded-full blur-3xl" />

              <div className="relative z-10">
                <div className="w-20 h-20 bg-gradient-to-br from-[#e6b800]/20 to-[#e6b800]/5 text-[#e6b800] rounded-3xl flex items-center justify-center mx-auto mb-8 border border-[#e6b800]/20 shadow-lg">
                  <MailIcon className="h-10 w-10" />
                </div>

                <h2 className="text-3xl md:text-4xl font-black mb-4 text-white tracking-tight">Stay ahead of <br /><span className="text-[#e6b800]">the curve</span></h2>
                ...
                <form onSubmit={handleSubscribe} className="space-y-5">
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 focus:border-[#e6b800]/50 focus:ring-4 focus:ring-[#e6b800]/10 rounded-2xl px-6 py-5 text-white placeholder:text-white/30 outline-none transition-all shadow-inner"
                      required
                    />
                  </div>
                  <Button
                    type="submit"
                    disabled={submitting}
                    className="w-full bg-[#e6b800] hover:bg-[#ffcc00] text-[#001529] font-black py-8 rounded-2xl text-lg shadow-xl shadow-[#e6b800]/20 transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:hover:scale-100"
                  >
...
export default IpoWorldMagazine;
