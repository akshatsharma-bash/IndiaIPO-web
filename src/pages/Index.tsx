...
const Index = () => {
  return (
    <div className="min-h-screen">
      <SEOHead
        title="India IPO | Expert IPO Consultancy & Advisory Services"
        description="India's leading IPO consultancy platform. Expert advisory for SME IPO, Mainline IPO, FPO, Pre-IPO funding and business valuation services."
        keywords="IPO, SME IPO, Mainline IPO, FPO, Pre-IPO, IPO Consultancy India, SEBI, IPO Advisory, Business Valuation"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "Organization",
          "name": "India IPO",
          "alternateName": "IndiaIPO",
          "url": BASE_URL,
          "logo": {
            "@type": "ImageObject",
            "url": `${BASE_URL}/favicon.png`
          },
          "description": "India's leading IPO advisory and consultancy platform offering expert services for SME IPO, Mainline IPO, FPO, Pre-IPO funding, Business Valuation and Capital Structuring.",
          "foundingDate": "2020",
          "address": {
            "@type": "PostalAddress",
          ...
          "knowsAbout": [
            "IPO Advisory", "SME IPO", "Mainline IPO", "ipo-advisory-services",
            "Pre-IPO Funding", "Business Valuation", "SEBI Regulations",
            "Capital Markets", "DRHP Preparation", "Corporate Finance"
          ],
          "hasOfferCatalog": {
            "@type": "OfferCatalog",
            ...
            "itemListElement": [
              ...
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Mainline IPO Advisory" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Business Valuation" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Pre-IPO Funding" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "FPO Advisory" } }
            ]
          }
        }}
      />
