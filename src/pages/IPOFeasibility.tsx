  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 space-y-20 pb-20">
        ...
        {/* IPO Eligibility Content Section */}
        <section className="relative !mt-0 pt-10 md:pt-12 pb-20 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-black font-heading text-foreground mb-5 tracking-tight">
            ...
            >
              ...
              <div className="relative z-10 p-8 md:p-12 text-background">
                ...
                <h3 className="text-3xl md:text-4xl font-black font-heading mb-5 leading-tight">
                ...
                <div className="mt-8 pt-6 border-t border-white/10">
                  <Button
                    size="lg"
                    className="h-14 px-8 bg-accent text-accent-foreground hover:bg-accent/90 rounded-full font-bold shadow-lg shadow-accent/20 transition-all hover:shadow-accent/30 hover:scale-[1.02]"
        ...
        <section className="container mx-auto px-4">
          <div className=" max-w-3xl  mb-16">
            <h2 className="text-3xl md:text-4xl font-bold font-heading text-foreground mb-4">Why Assess Your <strong className="text-accent">IPO</strong> Readiness?</h2>
        ...
        {currentIpoBlogs.length > 0 && (
          <section className="">
            <div className="container mx-auto px-4">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                <div>
                  <h2 className="text-3xl md:text-4xl font-bold font-heading text-foreground mb-4">Current IPO Blogs &amp; Updates</h2>
                ...
                <Button variant="outline" asChild className="shrink-0 rounded-full h-12 px-6">
                  <Link to="/ipo-blogs">View All Blogs <ArrowRight className="ml-2 w-4 h-4" /></Link>
                </Button>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {currentIpoBlogs.map((blog) => (
                  <Link to={`/ipo-blogs/${blog.slug || blog.id}`} key={blog.id} className="group flex flex-col bg-card rounded-2xl border border-border overflow-hidden hover:shadow-xl hover:border-primary/30 transition-all duration-300">
                    <div className="aspect-video relative overflow-hidden bg-muted">
