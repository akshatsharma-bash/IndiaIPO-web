...
const IPOServices = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <Header />
      <main>
        <section className="bg-[#001529] pt-16 relative overflow-hidden">
          {bannerVideo ? (
        ...
        <section className="container mx-auto px-4 py-16 space-y-24">
          ...
          >
            ...
            <p className="text-slate-900 text-lg md:text-xl font-extrabold leading-8 font-medium max-w-3xl mx-auto">
