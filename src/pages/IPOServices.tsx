...
const ServiceSection = ({
  ...
  return (
    ...
    >
      <div
        className={`rounded-3xl overflow-hidden mb-8 bg-gradient-to-r ${svc.gradient}`}
      >
        <div className="p-8 md:p-12 flex flex-col md:flex-row items-start md:items-center gap-6">
          ...
          <div className="flex-1">
            <span
              ...
              style={{
                background: svc.color + "30",
                color: svc.color === "#f59e08" ? "#f59e08" : "#fff",
      ...
      <p className="text-slate-600 text-base leading-relaxed mb-10 max-w-4xl font-medium">
        {svc.description}
      </p>
          ...
          <table className="w-full text-sm">
            <tbody>
              {svc.eligibility.map((row, i) => (
                ...
                >
                  <td className="px-5 py-3.5 font-bold text-slate-700 w-2/5 align-top">
                    {row.criteria}
                  </td>
    ...
    const fetchData = async () => {
      try {
        ...
        if (catRes.ok) {
          ...
          const comparisonCat = categories.find(
            (c: any) => c.slug === "service-comparison",
          );

          if (comparisonCat) {
            const itemsRes = await fetch(
              `/api/knowledge/items?category_id=${comparisonCat.id}`,
            );
            if (itemsRes.ok) {
        ...
        if (bannerRes.ok) {
          ...
          const activeBanner = bannerData.find(
      ...
      <main>
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-white/60 max-w-2xl text-base md:text-lg font-medium leading-relaxed mb-10">
                From Pre-IPO Funding to Mainboard listing — we provide
                end-to-end, SEBI-compliant IPO consultation for SMEs and large
                enterprises across all sectors and exchanges in India.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                <Button
                  ...
                  className="rounded-xl px-8 h-12 text-sm font-bold shadow-lg"
                >
                  <Link to="/all-ipos">View Live IPOs</Link>
                </Button>
              </div>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">
                <span className="text-[#f59e08]">Quick Comparison</span> — All
                Services
              </h2>
              <p className="text-slate-500 font-medium">
                Side-by-side overview to help you choose the right IPO pathway
              </p>
            </motion.div>
              ...
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-gradient-to-r from-[#001529] to-[#003380] text-white">
                    <th className="px-6 py-5 text-left font-bold text-xs uppercase tracking-widest">
                      Parameter
                    </th>
                    {services.map((s) => (
                      <th
                  ...
                  {comparisonData.map((row, ri) => (
                    ...
                    >
                      ...
                      {row.values.map((v: string, vi: number) => (
                        <td
                          key={vi}
                          className={`px-6 py-4 text-center font-medium ${v?.startsWith("✓") ? "text-green-600" : v?.startsWith("✗") ? "text-red-400" : "text-slate-600"}`}
                        >
                          {v}
                        </td>
                      ))}
        ...
        <section className="container mx-auto px-4 py-16 space-y-24">
          ...
          >
            ...
            <p className="text-slate-600 text-lg md:text-xl leading-8 font-medium max-w-3xl mx-auto">
              Choose the right listing pathway for your company. Each service
              comes with a dedicated deal team, comprehensive documentation
              support, and 360-degree advisory throughout the process.
            </p>
          </motion.div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-slate-500 font-medium max-w-2xl mx-auto">
                Our edge comes from deep domain expertise, a verified
                professional compliance framework, and a relentless focus on
                client success.
              </p>
            </motion.div>
        ...
        <section className="py-20 bg-white border-t border-slate-200">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">
                Frequently Asked{" "}
                <span className="text-[#f59e08]">Questions</span>
              </h2>
              <p className="text-slate-500 font-medium">
                Everything you need to know about IPO advisory services in
                India.
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-white/60 max-w-2xl mx-auto text-base font-medium mb-10">
                Talk to our expert IPO advisors today. Free initial consultation
                — no strings attached. We'll assess your company's IPO readiness
                and chart the ideal listing roadmap.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Button
                  asChild
                  variant="outlineWhite"
                  className="rounded-xl px-10 h-14 text-base font-bold shadow-lg"
                >
