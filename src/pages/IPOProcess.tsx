            ...
            <div>
              ...
              <div className="space-y-12">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Decision to Go Public</h3>
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Appointing a Merchant Banker (Lead Manager)</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Appointment of Key Advisors</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Due Diligence</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Preparation of the Draft Red Herring Prospectus (DRHP)</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">SEBI Review and Approval</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Stock Exchange Listing Application</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Roadshows and Pre-IPO Marketing</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Price Band and Book-Building Process</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">IPO Subscription Period</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Share Allotment and Stock Exchange Listing</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                    ...
                    <div className="bg-secondary/30 border border-border p-6 rounded-2xl">
                      <p className="text-muted-foreground leading-relaxed">
                        Stay updated with upcoming IPOs through the <Link to="/all-ipos" className="text-[#f59e08] font-bold hover:underline">IPO Calendar</Link> and explore detailed analysis at <Link to="/ipo-blogs" className="text-[#f59e08] font-bold hover:underline">IPO Company Reviews — GMP, Subscription Status & Allotment</Link>. For professional assistance, explore our <Link to="/ipo-advisory-services" className="text-[#f59e08] font-bold hover:underline">FPO Advisory</Link>, <Link to="/pre-ipo-consultant" className="text-[#f59e08] font-bold hover:underline">Pre-IPO Consulting</Link> and <Link to="/ipo-advisory-services" className="text-[#f59e08] font-bold hover:underline">Rights Issue Advisory</Link> services.
                      </p>
                    </div>
                  </div>
                </div>
