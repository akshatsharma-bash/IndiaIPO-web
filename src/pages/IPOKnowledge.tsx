...
const IPOKnowledge = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      <SEOHead
        title={activeCategory ? `${activeCategory.name} | India IPO Knowledge Center` : "IPO Knowledge Center | India IPO"}
            ...
            <div className="w-full lg:w-72 shrink-0 space-y-5">
                  ...
                  {categories.map((cat) => {
                    ...
                    return (
                      <Link key={cat.id}
                        ...
                        className={`flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all ${activeCategory?.id === cat.id
              ...
              <div className="bg-[#001529] rounded-2xl p-6 overflow-hidden relative">
                ...
                <p className="text-white/55 text-xs mb-5 leading-relaxed">
                  Our expert advisors are ready to guide you through every step of your IPO journey.
                </p>
                <Link to="/contact"
