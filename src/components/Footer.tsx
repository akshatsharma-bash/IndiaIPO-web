...
import logo from "@/assets/India IPO Company Logo.jpg";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center mb-4">
              <img src={logo} alt="India IPO" className="h-14 w-auto rounded-lg" />
            </div>
            ...
            <div className="flex gap-4">
              {[
                ...
                { icon: () => <span className="text-sm font-black">𝕏</span>, href: "https://x.com/india_ipo1", label: "X", color: "#000000" },
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-xl flex items-center justify-center transition-all hover:scale-110 shadow-lg border border-background/10"
                  style={{
                    color: social.color,
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = `0 10px 15px -3px ${social.color}40`;
                  }}
                  onMouseLeave={(e) => {
