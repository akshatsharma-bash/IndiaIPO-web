            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                    ...
                    {/* <a
                        ...
                        className="flex relative z-10 w-36 h-52 bg-white/10 bg-white/20 rounded-2xl items-center justify-center overflow-hidden border border-white/40 shadow-2xl  md:rotate-3 transition-colors duration-500 cursor-pointer"
                    >
                        <img
                            src={appPreviewImg}
                            loading="lazy"
                        ...
                        />
                        <div className="absolute inset-0 bg-blue-900/40 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center p-4 text-center">
