                        ...
                        {faqItems.length > 4 && (
                            ...
                            >
                                <button
                                    ...
                                    className="flex items-center gap-2 px-6 py-3 bg-blue-900 text-white rounded-xl text-sm font-bold hover:bg-blue-800 transition-all shadow-md active:scale-95"
                                >
                                    {showAll ? (
                                        <>
