                ...
                <div className="lg:w-1/2 space-y-10 relative z-10">
                    ...
                    >
                        <button
                            ...
                            className="group relative inline-flex items-center justify-center gap-3 px-10 py-5 bg-white text-slate-900 rounded-2xl font-black text-sm uppercase tracking-widest shadow-[0_20px_50px_-10px_rgba(255,255,255,0.3)] hover:scale-105 active:scale-95 transition-all"
                        >
